...
################################################################
# This is a generated script based on design: adder_design
#
...
# source adder_design_script.tcl
...
\
  ...
  set adder_0 [ create_bd_cell -type ip -vlnv aallioux:user:adder:1.0 adder_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins adder_0/S00_AXI]
  ...
  [get_bd_pins adder_0/s00_axi_aresetn]
  ...
  [get_bd_pins adder_0/s00_axi_aclk]
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs adder_0/S00_AXI/S00_AXI_reg] -force
