...
#
# pouet.tcl: Tcl script for re-creating project 'adder-axi-lite'
#
# Generated by Vivado on Sun Dec 28 16:09:52 +0100 2025
...
#
# 1. This project restoration tcl script (pouet.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/vivado/adder-axi-lite.srcs/sim_1/new/testbench.sv"
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/vivado/adder-axi-lite.srcs/utils_1/imports/synth_1/adder_design_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/rtl/half_adder.vhd"
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/rtl/full_adder.vhd"
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/rtl/adder.vhd"
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/rtl/slice.vhd"
#    "C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/constraints/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/adder-axi-lite.srcs/sim_1/new/testbench.sv"]"\
 "[file normalize "$origin_dir/adder-axi-lite.srcs/utils_1/imports/synth_1/adder_design_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../hw/rtl/half_adder.vhd"]"\
 "[file normalize "$origin_dir/../hw/rtl/full_adder.vhd"]"\
 "[file normalize "$origin_dir/../hw/rtl/adder.vhd"]"\
 "[file normalize "$origin_dir/../hw/rtl/slice.vhd"]"\
 "[file normalize "$origin_dir/../hw/constraints/constraints.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
 ...
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ip_repo/adder_slave_1_0"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ip_repo/adder_ip_1_0"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ip_repo/myip_1_0"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ip_repo/myip_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "adder-axi-lite"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/myip_1_0"] [file normalize "$origin_dir/../ip_repo/adder_slave_1_0"] [file normalize "$origin_dir/../ip_repo/adder_ip_1_0"] [file normalize "$origin_dir/../ip_repo/myip_1_0"] [file normalize "$origin_dir/../ip_repo/myip_1_0"]" $obj
...
set file "$origin_dir/../hw/rtl/half_adder.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hw/rtl/full_adder.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hw/rtl/adder.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hw/rtl/slice.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set_property -name "top" -value "adder_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../hw/constraints/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../hw/constraints/constraints.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../hw/constraints/constraints.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../hw/constraints/constraints.xdc"]" -objects $obj
...
set_property -name "top" -value "tb_axi_adder" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
set file "synth_1/adder_design_wrapper.dcp"
...
if { [get_files [list slice.vhd]] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/antoi/Documents/zynq-playground/adder-axi-lite/hw/rtl/slice.vhd
}


# Proc to create BD adder_design
proc cr_bd_adder_design { parentCell } {
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.90886",
   "Default View_TopLeft":"198,-30",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace portBus fan_en -pg 1 -lvl 4 -x 1170 -y 220 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 100 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 330 -y 310 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 790 -y 80 -defaultsOSRD
preplace inst slice_0 -pg 1 -lvl 3 -x 1040 -y 220 -defaultsOSRD
preplace inst adder_0 -pg 1 -lvl 3 -x 1040 -y 100 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 660 230 930
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 200 650 160 920J
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 210 630
preplace netloc zynq_ultra_ps_e_0_emio_ttc0_wave_o 1 1 2 640J 220 NJ
preplace netloc slice_0_dout 1 3 1 NJ 220
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 60
preplace netloc axi_smc_M00_AXI 1 2 1 N 80
levelinfo -pg 1 0 330 790 1040 1170
pagesize -pg 1 -db -bbox -sgen 0 0 1290 410
"
}
...
# End of cr_bd_adder_design()

cr_bd_adder_design ""
set_property REGISTERED_WITH_MANAGER "1" [get_files adder_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files adder_design.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list adder_design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/adder-axi-lite.gen/sources_1/bd/adder_design/hdl/adder_design_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list adder_design.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/adder_design_wrapper.dcp" -objects $obj
