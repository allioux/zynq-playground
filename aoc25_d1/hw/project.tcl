...
#
# project.tcl: Tcl script for re-creating project 'aoc'
#
# Generated by Vivado on Fri Jan 02 22:43:04 CET 2026
...
#
#    "/home/antoine/Documents/Hardware/aoc/hw/constraints/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/constraints/constraints.xdc"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/aoc_1_0"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/slice"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/vivado/aoc"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/aoc_1_0"] [file normalize "$origin_dir/ip_repo/slice"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:aoc:1.0\
  aallioux:user:slice:1.0\
  "
...
\
  ...
  set slice_0 [ create_bd_cell -type ip -vlnv aallioux:user:slice:1.0 slice_0 ]
  set_property -dict [list \
    CONFIG.lsb {2} \
    CONFIG.msb {2} \
    CONFIG.width {3} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins aoc_0/S00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net adder_0_bram_addr  [get_bd_pins aoc_0/bram_addr] \
  [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net adder_0_bram_en  [get_bd_pins aoc_0/bram_en] \
  [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net aoc_0_bram_we  [get_bd_pins aoc_0/bram_we] \
  [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net blk_mem_gen_1_douta  [get_bd_pins axi_bram_ctrl_0_bram/doutb] \
  [get_bd_pins aoc_0/bram_dout]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn  [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] \
  [get_bd_pins aoc_0/s00_axi_aresetn]
  ...
  [get_bd_pins aoc_0/s00_axi_aclk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs aoc_0/S00_AXI/S00_AXI_reg] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-82,-133",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace portBus fan_en -pg 1 -lvl 5 -x 1560 -y 440 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 370 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 800 -y 350 -defaultsOSRD
preplace inst rst_ps8_0_96M -pg 1 -lvl 1 -x 330 -y 180 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 1120 -y 360 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1420 -y 160 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -x 1120 -y 80 -defaultsOSRD
preplace inst aoc_0 -pg 1 -lvl 3 -x 1120 -y 210 -defaultsOSRD
preplace inst slice_0 -pg 1 -lvl 4 -x 1420 -y 440 -defaultsOSRD
preplace netloc adder_0_bram_addr 1 3 1 1260 130n
preplace netloc adder_0_bram_en 1 3 1 N 190
preplace netloc aoc_0_bram_we 1 3 1 N 230
preplace netloc blk_mem_gen_1_douta 1 2 2 980 10 1300J
preplace netloc rst_ps8_0_96M_peripheral_aresetn 1 1 2 650 240 950
preplace netloc xlconstant_0_dout 1 3 1 1270J 80n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 30 480 660 250 970 20 1290J
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 20 80 630
preplace netloc slice_0_dout 1 4 1 NJ 440
preplace netloc zynq_ultra_ps_e_0_emio_ttc0_wave_o 1 1 3 640J 260 940J 440 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 1280 90n
preplace netloc axi_smc_M00_AXI 1 2 1 N 340
preplace netloc axi_smc_M01_AXI 1 2 1 960 180n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 1 N 320
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 340
levelinfo -pg 1 0 330 800 1120 1420 1560
pagesize -pg 1 -db -bbox -sgen 0 0 1690 500
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vivado/aoc/aoc.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
